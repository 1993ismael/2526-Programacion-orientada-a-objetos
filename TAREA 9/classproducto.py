...
def menu():
    ...
    inventario.agregar_producto(Producto("001", "Arroz", 25, 1.50))
    inventario.agregar_producto(Producto("002", "Azucar", 18, 2.00))
    inventario.agregar_producto(Producto("003", "Aceite", 12, 3.75))
    inventario.agregar_producto(Producto("004", "Leche", 30, 0.95))
